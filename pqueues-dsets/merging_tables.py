...
class Database:
    ...
    def merge(self, dst, src):
        ...
        if self.ranks[dst_parent] == self.ranks[src_parent]: self.ranks[dst_parent] += 1
    ...
    def get_parent(self, table):
        ...
        if self.parents[self.parents[table]] != self.parents[table]: self.parents[table] = self.get_parent(self.parents[table])
